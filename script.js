...
const TABLE_PROJECTS = "tblATUdptrnXWOU"; // ID pour Projets récents
const TABLE_NEWS = "tblGKFbkcYHANXwk4"; // ID pour Actualités

// Fonction pour charger les projets récents
async function loadProjects() {
    const url = "https://api.airtable.com/v0/appAeViTSpJmhQouZ/tblebATUdptrnXWOU"; // L'URL complète pour les projets récents
    try {
...
async function loadNews() {
    const url = "https://api.airtable.com/v0/appAeViTSpJmhQouZ/tblGKfbkCyHANXwk4"; // L'URL complète pour les actualités
    try {
        const response = await fetch(url, {
            headers: {
                Authorization: `Bearer patCXkaXvHjOSWG5v.7052af79bbd1295ba884789d8ab9376e3d79c71d9b571435ac21cff7d3bdb661`,
